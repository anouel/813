...
Imagining a multivariate (multi-dimensional) distribution with more than two parameters can be tricky, but to understand uncertianty in logit, we must understand *covarience*.
