...
[`estat`](https://www.reed.edu/psychology/stata/analyses/parametric/Regression/pe/estat.html) returns various model statistics. For may of these statistics, we might use `summary()`, `glance()`, `augment()`, `vcov()` depending on what exactly we are after. 
