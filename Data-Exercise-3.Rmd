...
p +
  ...
  labs(color = "",
       y = "Predicted salary (thousands of dollars)") 
```

Why does this model fail to test the hypothesis? What did it test? How should we interpret the coefficient of `r round(m1$estimate[2],1)` on Gender? 
