...
```{r Statasetup, include=FALSE, eval=TRUE}
...
Women at the Deer Valley Utility Company claim that their job performances are not being rewarded to the same degree as the job performances of men. Is there statistical evidence to support this complaint? This summary analysis for the Director of the Office of Equal Opportunity includes findings and a brief discussion of other factors we may want to investigate before issuing a final report.

We have the following data for the 60 persons (22 women and 38 men) who completed the trainee program two years ago and remain employed by the company:
